        ...
        <div class="inline-block align-button bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog">
            <form>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                    <div class="mb-4">
                            <label for="id_peminjaman" class="block text-gray-700 text-sm font-bold mb-2">ID Pinjam:</label>
                            <input type="text" wire:model="id_peminjaman" class="shadow appearance-none border rounded w-full py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="id_peminjaman" name="id_peminjaman" required>
                            @error('id_peminjaman')
