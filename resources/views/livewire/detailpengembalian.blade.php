        ...
        <div class="inline-block align-button bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog">
            <form>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                    <div class="mb-4">
                            <label for="id_pengembalian" class="block text-gray-700 text-sm font-bold mb-2">ID Pengembalian:</label>
                            <input type="text" wire:model="id_pengembalian" class="shadow appearance-none border rounded w-full py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="id_pengembalian" name="id_pengembalian" required>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" wire:model="tanggal_pengembalian" class="shadow appearance-none border rounded w-full py-2 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="tanggal_pengembalian" name="tanggal_pengembalian" required>
