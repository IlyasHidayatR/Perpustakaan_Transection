    ...
    <h2><b>Daftar Rak</b></h2>
            ...
            <table class="bg-white text-gray-900 w-full shadow-none">
                <thead>
                    ...
                    <th class="bg-blue-700 text-white p-2">Nama Rak</th>
                    <th class="bg-blue-700 text-white p-2">Lokasi Rak</th>
                ...
                <!-- $loop->iteration -->
                    ...
                    <th class="p-2">{{$rk->nama_rak}}</th>
                    <th class="p-2">{{$rk->lokasi_rak}}</th>
                    <th class="p-2">{{$rk->Buku->judul_buku}}</th>
                    <th class="p-2">
                        <button wire:click="show({{$rk->id_rak}})" class="border" style="background-color:aqua; color:white">detail</button>
                        @if ($isModal1)
                            @include('livewire.detailrak')
                        @endif
                        <button wire:click="edit({{$rk->id_rak}})" class="border" style="background-color:green; color:white">edit</button>
                        <button wire:click="delete({{$rk->id_rak}})" class="badge badge-danger inline border" style="background-color:red; color:white">delete</button>
                    </th>
                </tr>
                @empty
                    <tr>
