    ...
    <h2><b>Daftar Pengembalian</b></h2>
            ...
            <table class="bg-white text-gray-900 w-full shadow-none">
                <thead>
                    ...
                    <th class="bg-blue-700 text-white p-2">Jumlah Denda</th>
                ...
                <!-- $loop->iteration -->
                    ...
                    <th class="p-2">{{$kbl->Petugas->nama_petugas}}</th>
                    <th class="p-2">
                        <button wire:click="show({{$kbl->id_pengembalian}})" class="border" style="background-color:aqua; color:white">detail</button>
                        @if ($isModal1)
                            @include('livewire.detailpengembalian')
                        @endif
                        <button wire:click="edit({{$kbl->id_pengembalian}})" class="border" style="background-color:green; color:white">edit</button>
                        <button wire:click="delete({{$kbl->id_pengembalian}})" class="badge badge-danger inline border" style="background-color:red; color:white">delete</button>
                    </th>
                </tr>
                @empty
                    <tr>
